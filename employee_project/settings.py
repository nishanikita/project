...
SECRET_KEY = 'django-insecure-&qftkzvk_wv34!j_6%70(t*!ll0ob+q7#+agiy1hgi3l%=6&%+'
...
LOGIN_URL = '/login/'  # Specify the login URL for @login_required decorator
...
TEMPLATES = [
    {
        ...
        'DIRS': [ BASE_DIR / 'employee_register' / 'templates'/'employee_register',],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Blpadmin@123',        # Replace with your database password
